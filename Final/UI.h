...
public:
    ...
    void tituloCoursera(int fila, int columna) {
        _setmode(_fileno(stdout), _O_U16TEXT); // Cambia a UTF-16 para wcout
        ...
        std::wcout << L"░█▀▀░█▀█░█░█░█▀▄░█▀▀░█▀▀░█▀▄░█▀█              \n";
        moverCursor(fila + 4, columna);
        std::wcout << L"░█░░░█░█░█░█░█▀▄░▀▀█░█▀▀░█▀▄░█▀█              \n";
        moverCursor(fila + 5, columna);
        std::wcout << L"░▀▀▀░▀▀▀░▀▀▀░▀░▀░▀▀▀░▀▀▀░▀░▀░▀░▀              \n";

        _setmode(_fileno(stdout), _O_TEXT); // Restaurar modo texto
    } 
